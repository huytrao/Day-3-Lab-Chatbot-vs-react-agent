...
2. **Reliability**:
   Dù thông minh nhưng ReAct Agent _kém ổn định_ về thì giờ phản hồi. Tốc độ API trả về với Chatbot thuần có thể chỉ dưới 1-2 giây. Trong khi đó, Frontend nhiều lúc gặp Timeout do request POST đến `/api/chat` phải chờ ReAct Agent chạy vòng lặp suy luận đôi khi lên đến 15 giây. Khi quá nhiều `chat_history` bị nhiễu, ReAct thỉnh thoảng sẽ dự đoán sai tên Tool gây ra vòng lặp vô tận.
3. **Observation**:
